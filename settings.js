...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=TZ0UAKhR#npNAlLWF7N8jOYkK4WqASavFVmO2q0Q9a6nQ0OnYp1M' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94703090240' : process.env.OWNER_NUMBER,   
ONLY_GROUP: process.env.ONLY_GROUP === undefined ? 'ture' : process.env.ONLY_GROUP,
